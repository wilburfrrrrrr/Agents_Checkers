...
def get_q_learning_agent():
	...
	q_learning_agent.q_learning(CheckersGame())
...
def play_game(player_1, player_2):
	...
	while not game.is_over():
		...
		if game.whose_turn() == 1:
			move = player_1.choose_action(game, game.get_possible_moves())
		else:
			move = player_2.minimax_alpha_beta(game, 3, False)
